...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        #######################################################################
        #new_intersect = self.h_rect.get_center()
        new_capitalt = CapitalT(self.intersection_center, self.width, self.height, self.letter_thickness)
        new_capitalt.h_rect.fill_color = self.h_rect.fill_color
        new_capitalt.v_rect.fill_color = self.v_rect.fill_color
        new_capitalt.h_rect.outline_color = self.h_rect.outline_color
        new_capitalt.v_rect.outline_color = self.v_rect.outline_color
        return new_capitalt
